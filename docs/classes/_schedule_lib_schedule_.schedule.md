[COVID Tutoring Initiative Docs](../README.md) › [Globals](../globals.md) › ["schedule/lib/schedule"](../modules/_schedule_lib_schedule_.md) › [Schedule](_schedule_lib_schedule_.schedule.md)

# Class: Schedule <**P, S, SS, P, S**>
...
- [constructor](_schedule_lib_schedule_.schedule.md#constructor)

### Properties

- [context](_schedule_lib_schedule_.schedule.md#context)
- [props](_schedule_lib_schedule_.schedule.md#props)
- [refs](_schedule_lib_schedule_.schedule.md#refs)
- [state](_schedule_lib_schedule_.schedule.md#state)
- [contextType](_schedule_lib_schedule_.schedule.md#static-optional-contexttype)

### Methods

- [UNSAFE_componentWillMount](_schedule_lib_schedule_.schedule.md#optional-unsafe_componentwillmount)
- [UNSAFE_componentWillReceiveProps](_schedule_lib_schedule_.schedule.md#optional-unsafe_componentwillreceiveprops)
- [UNSAFE_componentWillUpdate](_schedule_lib_schedule_.schedule.md#optional-unsafe_componentwillupdate)
- [componentDidCatch](_schedule_lib_schedule_.schedule.md#optional-componentdidcatch)
- [componentDidMount](_schedule_lib_schedule_.schedule.md#optional-componentdidmount)
- [componentDidUpdate](_schedule_lib_schedule_.schedule.md#optional-componentdidupdate)
- [componentWillMount](_schedule_lib_schedule_.schedule.md#optional-componentwillmount)
- [componentWillReceiveProps](_schedule_lib_schedule_.schedule.md#optional-componentwillreceiveprops)
- [componentWillUnmount](_schedule_lib_schedule_.schedule.md#optional-componentwillunmount)
- [componentWillUpdate](_schedule_lib_schedule_.schedule.md#optional-componentwillupdate)
- [forceUpdate](_schedule_lib_schedule_.schedule.md#forceupdate)
- [getSnapshotBeforeUpdate](_schedule_lib_schedule_.schedule.md#optional-getsnapshotbeforeupdate)
- [render](_schedule_lib_schedule_.schedule.md#render)
- [setState](_schedule_lib_schedule_.schedule.md#setstate)
- [shouldComponentUpdate](_schedule_lib_schedule_.schedule.md#optional-shouldcomponentupdate)

## Constructors

### constructor

\+ **new Schedule**(`props`: Readonly‹P›): _[Schedule](_schedule_lib_schedule_.schedule.md)_
...
**Returns:** _[Schedule](_schedule_lib_schedule_.schedule.md)_

\+ **new Schedule**(`props`: P, `context?`: any): _[Schedule](_schedule_lib_schedule_.schedule.md)_
...
_Defined in [src/schedule/lib/schedule.tsx:8](https://github.com/tutorbookapp/covid-tutoring/blob/7978780/src/schedule/lib/schedule.tsx#L8)_
